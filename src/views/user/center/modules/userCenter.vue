            ...
            <a-row :gutter="48">
              ...
              <!-- <a-col :xs="24"
                ...
                <a-form-item label="生效时间"
                             :colon="false">
                  <a-input placeholder="生效时间"
                           v-decorator="['tax_start']" />
                  <div class="disable-box"></div>
                </a-form-item>
              </a-col>
              <a-col :xs="24"
  ...
  methods: {
    ...
    setForm (res) {
      ...
      const item = {
        ...
        department_id: res.data.department_user? res.data.department_user.department_id:undefined,
