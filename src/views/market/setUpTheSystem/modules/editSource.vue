          ...
          <a-col :xs="24" :sm="24" :lg="{span:14,offset:5}">
            <a-row :gutter="24">
              <a-col :xs="24" :sm="24" :lg="12">
                <a-form-item label="系统名称" :colon="false">
                  <a-input
                    placeholder="请输入系统名称"
              ...
              <a-col :xs="24" :sm="24" :lg="12">
                <a-form-item label="IP地址" :colon="false">
                  <a-input placeholder="请输入IP地址" v-decorator="['source_url']" />
                </a-form-item>
              </a-col>
              <a-col :xs="24" :sm="24" :lg="12">
                <a-form-item label="密钥" :colon="false">
                  <a-input placeholder="请输入密钥" v-decorator="['source_short_name']" />
                </a-form-item>
              </a-col>
              <a-col :xs="24" :sm="24" :lg="12">
