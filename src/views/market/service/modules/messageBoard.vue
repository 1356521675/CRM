    ...
    <div class="show" v-show="visible">
      <div class="data-list">
        <div class="tab-content" style="border:none">
          <!-- <a-tabs :activeKey="this.jump" :animated="false" @change="localJump">
            <a-tab-pane key="1">
              <span slot="tab">淘宝留言</span>
            </a-tab-pane>
            <a-tab-pane key="2">
              <span slot="tab">拼多多留言</span>
            </a-tab-pane>
          </a-tabs> -->
          <a-form
          ...
          >
            <a-row :gutter="0">
              <a-col :xs="24" :sm="24" :lg="9" :xl="9" :xxl="7" style>
              ...
              >
                <a-form-item :colon="false">
                  <a-input-group compact>
                    <a-input v-model="suosou" placeholder="请输入QQ/微信/手机" style="width:100%" />
                  </a-input-group>
                </a-form-item>
              </a-col>
              <a-col
              ...
              >
                <span style="margin-right:6px; font-weight: 600;">导入状态</span>
                <a-radio-group name="radioGroup" defaultValue @change="onChanges" v-model="values">
                  <a-radio value="0">未添加</a-radio>
                  <a-radio value="1">添加成功</a-radio>
                  <a-radio value="2">重复数据</a-radio>
                  <a-radio value>全部</a-radio>
                </a-radio-group>
              </a-col>
              <a-col :xs="24" :sm="24" :lg="24" :xl="2" :xxl="1" :style="{ textAlign: 'left' }">
            ...
            <a-col :xs="24" :sm="24" :lg="24" :xl="5" :xxl="5" :style="{ textAlign: 'left' }">
              <a-button
                style="margin-left:22px; margin-top:55px"
                class="btn-primary"
                size="small"
                @click="daoru"
              >选择导入</a-button>
    ...
    return {
      ...
      loadData: parameter => {
        if (this.jump == 1) {
          ...
          return getPddmessageBoard(Object.assign(parameter, this.queryParam))
            .then(res => {
              res.data.data.forEach((item, i) => {
                item.keyIndex = i;
              });
