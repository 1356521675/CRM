        ...
        >
          <a-row :gutter="24">
            <a-row :gutter="16">
              ...
              <a-col :xs="24" :sm="24" :lg="12">
                <a-form-item label="域名" :colon="false">
                  <a-input v-model="columns.host" disabled />
                </a-form-item>
              </a-col>
              <a-col :xs="24" :sm="24" :lg="12">
                <a-form-item label="来源" :colon="false">
                  <a-input v-model="columns.source" disabled />
                </a-form-item>
              </a-col>
              <a-col :xs="24" :sm="24" :lg="12">
              ...
              <a-col :xs="24" :sm="24" :lg="12">
                <a-form-item label="导入状态" :colon="false">
                  <!-- <a-input v-model="columns.import_status.text"  /> -->
                  <a-select v-model="columns.import_status.value" @change="serviceStatusChange">
                    ...
                    <a-select-option :value="3">添加失败</a-select-option>
                  </a-select>
                </a-form-item>
              </a-col>
            </a-row>
